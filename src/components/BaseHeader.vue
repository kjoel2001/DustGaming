          ...
          <div class="navbar__action">
            ...
            >
              <div class="header__dropdown-content">
                <router-link v-if="!isLoggedIn" :to="{ name: 'Login' }" class="header__account-link">Iniciar Sesión</router-link>
                <router-link v-if="!isLoggedIn" :to="{ name: 'Register' }" class="header__account-link">Registrarse</router-link>
                <router-link v-else :to="{ name: 'Cuenta' }" class="header__account-link">Mi Cuenta</router-link>
                <button v-if="isLoggedIn" class="header__account-link" @click="logout">Cerrar Sesión</button>
              </div>
            </div>
          </div>
            <div
...
export default {
  ...
  computed: {
    ...
    isLoggedIn() {
      return this.$store.state.isLoggedIn;  // Obtener el estado de isLoggedIn desde el store
    }
  },
